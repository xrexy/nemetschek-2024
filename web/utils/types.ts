...
export type HistoryEvents = 'created' | 'drone-created' | 'drone-battery-update' | 'drone-returned' | 'drone-sent' | 'order-fulfilled' | 'order-added' | 'warehouse-added' | 'customer-added' | 'product-added'
